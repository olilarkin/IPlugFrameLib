...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugFrameLib-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFrameLib-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFrameLib-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFrameLib-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFrameLib-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugFrameLib.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugFrameLib.iss",inplace=1):
