...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugFrameLib Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugFrameLib Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugFrameLib Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugFrameLib installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugFrameLib Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugFrameLib installer\n"
